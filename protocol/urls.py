...
urlpatterns = [
    ...
    path('download-template-excel-press-union/', download_excel_press_union, name='download_excel_press_union'), #Путь для скачивания excel файла как шаблон (для обеденненого протокола ПРЕСС)
    path('download-template-zip-union/', download_rar_press_union, name='download_rar_press_union'), #Путь для скачивания zip-архива как шаблон (для обеденненого протокола ПРЕСС)
